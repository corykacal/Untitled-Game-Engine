//
// Created by Cory Kacal on 9/4/24.
//

#include <vector>
#include <array>
#ifndef UNTITLED_MARCHINGCUBESLOOKUPTABLE_H
#define UNTITLED_MARCHINGCUBESLOOKUPTABLE_H


const std::array<std::array<int, 2>, 12> edgeToVertex = {{
    {0, 1}, {1, 3}, {3, 2}, {2, 0},
    {4, 5}, {5, 7}, {7, 6}, {6, 4},
    {0, 4}, {1, 5}, {3, 7}, {2, 6}
}};
...
const std::array<std::vector<int>, 256> triTable = {{
    {},
    {0, 3, 8},
    {0, 9, 1},
    {3, 8, 1, 1, 8, 9},
...
inline constexpr int GetEdgeMask(int cubeIndex) {
    return edgeTable[cubeIndex];
}

inline const std::vector<int>& GetTriangles(int cubeIndex) {
    return triTable[cubeIndex];
}

#endif //UNTITLED_MARCHINGCUBESLOOKUPTABLE_H
